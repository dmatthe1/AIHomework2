    ...
    def train( self, trainingData, trainingLabels, validationData, validationLabels ):
        ...
        for iteration in range(self.max_iterations):
            ...
            for i in range(len(trainingData)):
                ...
                currentY = trainingLabels[i]
                # If y′= y, we've gotten the instance correct, and we do nothing
                if highestY != currentY:
                    #We guessed y′ but we should have guessed y 
                    #Wy' should have score f higher and Wy should have scored f lower
                    self.weights[currentY] += data
                    self.weights[highestY] -= data
